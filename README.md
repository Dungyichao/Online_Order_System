...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td align="Left"><b>ExtraAdd</b> <br />* <b>name (string)</b>: add item name<br />* <b>price (number)</b>: price<br /><br /> <b>FriedRice</b> <br /> * <b>default (boolean)</b>: default select option, only free fried rice is default<br /> * <b>name (string)</b>: fried rice item name<br /> * <b>price (number)</b>: fried rice item price<br /><br /> <b>Setting</b> <br /> * <b>OrderStatus (boolean)</b>: whenever customer is going to place the order, system will first check this status, only true can the order be submitted<br /> </td>
        </tr>
        <tr>
